...
TEXT_HINT = {'fr':{
    ...
    31: """Level 31  To collect the batteries from one side to the other, advance the middle tunnel one tile at a time. To progress, you need to hold back from collecting batteries right away. Instead, move the other nebulon to the right place first""",
