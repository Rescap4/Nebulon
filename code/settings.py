...
TEXT_HINT = {'fr':{
    ...
    23: """Niveau 23  The upper side is a trap, focus on the bottom of the level to align both nebulons on the exit row""",
    ...
    6: """Level 6  The order in which batteries are collected always matters""",
    ...
    23: """Level 23  La partie supérieure du niveau est un piège, la partie du bas est la seule qui peut aider à sortir les deux nebulons""",
    ...
    31: """Level 31  Reaching the other end one tile at a time requires moving a nebulon to the other side while the other is next to the spikes""",
